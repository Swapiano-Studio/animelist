          ...
          <>
            ...
            <div className="flex items-center gap-2 sm:gap-4 mb-4 w-full">
              <div className="flex w-full items-center gap-2 sm:gap-4">
                <button
                  className="flex-1 bg-red-500 hover:bg-red-600 text-white px-5 py-2 rounded-lg font-semibold transition"
                  onClick={handlePrev}
                >
                  &larr; Prev
                </button>
                <button
                  className="flex-1 bg-white/10 hover:bg-white/20 text-white px-5 py-2 rounded-lg font-semibold border border-white/20 transition"
                  onClick={handleNext}
                >
                  Next &rarr;
                </button>
              ...
              <div className="w-full flex justify-center mt-2 sm:mt-0">
                {anime.trailer?.url && (
                  <a
                    ...
                    className="block w-full sm:w-auto bg-blue-500 hover:bg-blue-600 text-white px-5 py-2 rounded-lg font-semibold transition shadow focus:outline-none focus:ring-2 focus:ring-blue-400 text-center"
